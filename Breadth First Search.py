...
class BreadthFirstSearch():
    ...
    def synthesize(self, bound, integer_operations, integer_values, variables, input_output):
        ...
        marker=len(var_num)
        tracker=1
        while (len(_open) != 0 and iteration<=bound ):
            p = _open.pop(0)
...
start = time.time()
synthesizer.synthesize(5, [ Lt, Ite], [1, 2], ['x', 'y'],[{'x': 5, 'y': 10, 'out': 5}, {'x': 10, 'y': 5, 'out': 5}, {'x': 4, 'y': 3, 'out': 3}])
end = time.time()
...
start = time.time()
synthesizer.synthesize(5, [And, Plus,Times, Lt, Ite, Not], [10], ['x', 'y'],[{'x': 5, 'y': 10, 'out': 5}, {'x': 10, 'y': 5, 'out': 5}, {'x': 4, 'y': 3, 'out': 4},{'x': 3, 'y': 4, 'out': 4}])
end = time.time()
print(f"Execution time: {end - start}")
print("#############################################\n")
...
start = time.time()
synthesizer.synthesize(5, [And,Plus, Times, Lt, Ite,Not], [-1, 5], ['x', 'y'], [{'x': 10, 'y': 7, 'out': 17},{'x': 4, 'y': 7, 'out': -7},{'x': 10, 'y': 3, 'out': 13},{'x': 1, 'y': -7, 'out': -6},{'x': 1, 'y': 8, 'out': -8}])
end = time.time()
print(f"Execution time: {end - start}")
print("#############################################\n")
